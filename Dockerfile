...
ENTRYPOINT ["java", "-cp", "/app:/app/dependencies/*:/app/snapshot-dependencies/*:/app/spring-boot-loader/*:/app/application/*", "org.springframework.boot.loader.launch.JarLauncher"]